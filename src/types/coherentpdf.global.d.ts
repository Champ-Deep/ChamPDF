/*
 * coherentpdf.global.d.ts — TypeScript type definitions for ChamPDF / CoherentPDF integration
 *
 * These type definitions were written by Alam for use in the ChamPDF project.
