...
export const dom = {
  ...
  signatureLibraryModal: document.getElementById('signature-library-modal'),
  openSignaturesBtn: document.getElementById('open-signatures-btn'),
  openSignaturesBtnMobile: document.getElementById(
    'open-signatures-btn-mobile'
  ),
};
